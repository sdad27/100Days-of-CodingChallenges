...
let usernames : string [] = ["saeed","ahmed","ali","qusai","admin"];
for(let un of usernames){
    if (un == "admin") {
        console.log(`Hello ${un}, would you like to see a status report?`);
    }else{
        console.log(`Hello ${un}, thank you for logging in again`);
